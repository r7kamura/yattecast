...
- [Ergo42](https://booth.pm/ja/items/842147)

【話者注】[Arduino](https://www.arduino.cc/)はJavaじゃなくてCのサブセットでした。（Javaのサブセットなのは[Processing](https://processing.org/)でした。すみません…）
